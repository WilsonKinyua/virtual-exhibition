...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.companies.update", [$company->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="website_url">{{ trans('cruds.company.fields.website_url') }}</label>
                <textarea class="form-control {{ $errors->has('website_url') ? 'is-invalid' : '' }}" name="website_url" id="website_url">{{ old('website_url', $company->website_url) }}</textarea>
                @if($errors->has('website_url'))
                    <div class="invalid-feedback">
                        {{ $errors->first('website_url') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.company.fields.website_url_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $company->phone_number) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('logo') ? 'is-invalid' : '' }}" name="logo" id="logo">{{ old('logo', $company->logo) }}</textarea>
                @if($errors->has('logo'))
                    <div class="invalid-feedback">
                        {{ $errors->first('logo') }}
                    </div>

<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('chat_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/chat-rooms*") ? "c-show" : "" }} {{ request()->is("admin/chats*") ? "c-show" : "" }}">
        ...
        @can('exhibitor_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/exhibitors*") ? "c-show" : "" }} {{ request()->is("admin/exhibitor-videos*") ? "c-show" : "" }} {{ request()->is("admin/exhibitor-documents*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
